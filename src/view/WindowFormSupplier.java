...
public class WindowFormSupplier extends JFrame {
    ...
    public void submitToDB() {
        ...
        ((DefaultTableModel) tbl.getModel()).addRow(
                new Object[]{
                    Operator.getLastIDSupplier(core.getConnection()),
                    tfNama.getText(),
                    tfAlamat.getText(),
                    tfTelp.getText(),
                    tfTelp.getText(),});
    ...
    public Supplier getSupplier() {
        return new Supplier(tfNama.getText(),
                tfAlamat.getText(),
                tfTelp.getText());
    }
}
